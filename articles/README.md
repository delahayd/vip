# Déduction Modulo Théorie dans VIP
...
- "Experimenting with Deduction Modulo ?", G.Burel.
- "Polarized Resolution Modulo", G.Dowek (cité pour les one way clauses dans D.Delahaye).
